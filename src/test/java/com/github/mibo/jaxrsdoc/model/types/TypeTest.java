package com.github.mibo.jaxrsdoc.model.types;
...
//        final Type type = new Type("com.github.mibo.jaxrsdoc.model.Types.TypeTest$ConfigurationManager$Configuration");
//        assertThat(type.getCtClass().getName(), is("com.github.mibo.jaxrsdoc.model.Types.TypeTest$ConfigurationManager$Configuration"));
//        assertThat(type.toString(), is("com.github.mibo.jaxrsdoc.model.Types.TypeTest$ConfigurationManager$Configuration"));
//        assertThat(type.getTypeParameters().size(), is(0));
//    }
//
