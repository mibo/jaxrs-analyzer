...
public class TestClass15 {
    ...
    public static ClassResult getResult() {
        final MethodResult method = MethodResultBuilder
                ...
                .andQueryParam("value", "Lcom/github/mibo/jaxrsdoc/analysis/project/classes/testclasses/TestClass15$InnerTestClass15;", "FIRST")
                .build();

        return ClassResultBuilder
                .withResourcePath("test")
                .andMethods(method)
                .andQueryParam("id", "Lcom/github/mibo/jaxrsdoc/analysis/project/classes/testclasses/TestClass15$InnerTestClass15;", "FIRST")
                .build();
    }
