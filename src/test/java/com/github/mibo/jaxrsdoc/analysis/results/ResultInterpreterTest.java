...
import com.github.mibo.jaxrsdoc.builder.*;
...
import static com.github.mibo.jaxrsdoc.analysis.results.TypeUtils.STRING_IDENTIFIER;
...
public class ResultInterpreterTest {
    ...
    public void testAmbiguousEntityTypes() {
        final String configurationType = "Lcom/github/mibo/jaxrsdoc/analysis/results/ResultInterpreterTest$ConfigurationManager$Configuration;";
