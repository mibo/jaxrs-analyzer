...
package com.github.mibo.jaxrsdoc.analysis.bytecode.collection;
...
public class ByteCodeCollectorTest {
    ...
    public static Collection<Object[]> data() throws NotFoundException, IOException, ReflectiveOperationException {
        ...
        final Set<String> testClasses = TestClassUtils.getClasses("com/github/mibo/jaxrsdoc/analysis/bytecode/collection/testclasses");
