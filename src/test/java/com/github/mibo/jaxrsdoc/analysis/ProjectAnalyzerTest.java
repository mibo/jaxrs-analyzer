...
public class ProjectAnalyzerTest {
    ...
    private static Resources getResources() {
        ...
        final TypeIdentifier modelIdentifier = TypeIdentifier.ofType("Lcom/github/mibo/jaxrs_test/Model;");
        ...
        final TypeIdentifier modelListIdentifier = TypeIdentifier.ofType("Ljava/util/List<+Lcom/github/mibo/jaxrs_test/Model;>;");
