...
package com.github.mibo.jaxrsdoc.analysis.project.classes;
...
public class ClassAnalyzerTest {
    ...
    public static Collection<Object[]> data() throws NotFoundException, ReflectiveOperationException {
        ...
        final Set<String> testClasses = TestClassUtils.getClasses("com/github/mibo/jaxrsdoc/analysis/project/classes/testclasses");
