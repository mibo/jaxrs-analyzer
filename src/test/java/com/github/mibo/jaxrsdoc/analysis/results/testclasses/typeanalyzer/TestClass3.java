...
public class TestClass3 {
    ...
    public static Set<TypeRepresentation> expectedTypeRepresentations() {
        ...
        final TypeIdentifier innerClassIdentifier = TypeIdentifier.ofType("Lcom/github/mibo/jaxrsdoc/analysis/results/testclasses/typeanalyzer/TestClass3$InnerClass;");
        final TypeIdentifier typeIdentifier = TypeIdentifier.ofType("Lcom/github/mibo/jaxrsdoc/analysis/results/testclasses/typeanalyzer/TestClass3$Type;");
        final TypeIdentifier anotherInnerIdentifier = TypeIdentifier.ofType("Lcom/github/mibo/jaxrsdoc/analysis/results/testclasses/typeanalyzer/TestClass3$AnotherInner;");
    ...
    public static TypeIdentifier expectedIdentifier() {
        return TypeIdentifier.ofType("Lcom/github/mibo/jaxrsdoc/analysis/results/testclasses/typeanalyzer/TestClass3;");
    }
