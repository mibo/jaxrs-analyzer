...
public class TestClass59 {
    ...
    public static Set<HttpResponse> getResult() {
        ...
        responseFound.getEntityTypes().add("Lcom/github/mibo/jaxrsdoc/analysis/classes/testclasses/resource/response/TestClass59$ConfigurationManager$Configuration;");
