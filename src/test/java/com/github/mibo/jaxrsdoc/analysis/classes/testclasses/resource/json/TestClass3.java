...
public class TestClass3 {
    ...
    public static Set<HttpResponse> getResult() {
        ...
        final com.github.mibo.jaxrsdoc.model.elements.JsonObject innerObject = new com.github.mibo.jaxrsdoc.model.elements.JsonObject();
        innerObject.getStructure().put("duke", new Element(Types.INTEGER, 42));
        jsonObject.getStructure().put("object", new Element(Types.JSON_OBJECT, innerObject));
