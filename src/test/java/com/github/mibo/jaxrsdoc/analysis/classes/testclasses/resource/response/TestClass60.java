...
public class TestClass60 {
    ...
    public static Set<HttpResponse> getResult() {
        ...
        responseFound.getEntityTypes().add("Lcom/github/mibo/jaxrsdoc/analysis/classes/testclasses/resource/response/TestClass60$ConfigurationManager$Configuration;");
