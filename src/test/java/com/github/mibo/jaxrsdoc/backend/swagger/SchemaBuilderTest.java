...
public class SchemaBuilderTest {
    ...
    public void testMultipleDifferentDefinitions() {
        ...
        assertThat(cut.build(TypeIdentifier.ofType("Lcom/github/mibo/test/Model;")).build(), is(Json.createObjectBuilder().add("$ref", "#/definitions/Model").build()));
    ...
    public void testEnumDefinitions() {
        final TypeIdentifier enumIdentifier = TypeIdentifier.ofType("Lcom/github/mibo/test/Enumeration;");
        final Map<String, TypeIdentifier> modelProperties = new HashMap<>();
