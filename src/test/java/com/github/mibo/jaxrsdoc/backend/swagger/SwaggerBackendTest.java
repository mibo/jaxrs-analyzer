...
import static com.github.mibo.jaxrsdoc.backend.swagger.TypeIdentifierTestSupport.*;
...
//            assertEquals(expectedOutput, actualOutput);
    ...
    public static Collection<Object[]> data() {
        ...
        // Enum type tests
        identifier = TypeIdentifier.ofType("Lcom/github/mibo/test/FirstEnum;");
        final TypeIdentifier secondIdentifier = TypeIdentifier.ofType("Lcom/github/mibo/test/SecondEnum;");
        add(data, ResourcesBuilder.withBase("rest")
