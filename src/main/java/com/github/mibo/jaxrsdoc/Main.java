...
public class Main {
    ...
    private static void printUsageAndExit() {
        System.err.println("Usage: java -jar jaxrsdoc.jar [options] classPath [classPaths...]");
        ...
        System.err.println("\nExample: java -jar jaxrsdoc.jar -b swagger -n \"My Project\" -cp ~/libs/lib1.jar:~/libs/project/bin ~/project/target/classes");
        System.exit(1);
    }
