...
import com.github.mibo.jaxrsdoc.analysis.bytecode.collection.InstructionBuilder;
...
class ProjectMethodVisitor extends MethodVisitor {
    ...
    public void visitInsn(int opcode) {
        methodResult.getInstructions().add(InstructionBuilder.buildInstruction(opcode, getLastLabel()));
    }

    @Override
    public void visitIntInsn(int opcode, int operand) {
        methodResult.getInstructions().add(InstructionBuilder.buildIntInstruction(opcode, operand, getLastLabel()));
    }

    @Override
    public void visitVarInsn(int opcode, int index) {
        final Label label = !visitedLabels.isEmpty() ? visitedLabels.get(visitedLabels.size() - 1) : null;
        methodResult.getInstructions().add(InstructionBuilder.buildLoadStoreInstruction(opcode, index, label));
    }

    @Override
    public void visitTypeInsn(int opcode, String className) {
        methodResult.getInstructions().add(InstructionBuilder.buildTypeInstruction(opcode, className, getLastLabel()));
    }

    @Override
    public void visitFieldInsn(int opcode, String owner, String name, String desc) {
        methodResult.getInstructions().add(InstructionBuilder.buildFieldInstruction(opcode, owner, name, desc, getLastLabel()));
    }

    @Override
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
        methodResult.getInstructions().add(InstructionBuilder.buildInvokeInstruction(opcode, owner, name, desc, getLastLabel()));
    }
    ...
    public void visitInvokeDynamicInsn(String name, String desc, Handle bsm, Object... bsmArgs) {
        ...
        methodResult.getInstructions().add(InstructionBuilder.buildInvokeDynamic(className, name, desc, handle, getLastLabel()));
    }

    @Override
    public void visitJumpInsn(int opcode, Label label) {
        methodResult.getInstructions().add(InstructionBuilder.buildJumpInstruction(opcode, label));
    }
